...
#%%
runcell('Read csv and create Pandas Data Frame', 'D:/WZL_ags/12 Skit AE Pipe/Bohrer/DataPrep_full.py')
#runcell('Combine Features', 'D:/WZL_ags/12 Skit AE Pipe/Bohrer/DataPrep_full.py')
runcell('Auswahl eines Werkzeugs od. Prozessparameter', 'D:/WZL_ags/12 Skit AE Pipe/Bohrer/DataPrep_full.py')
#runcell('Drop or keep defined features', 'D:/WZL_ags/12 Skit AE Pipe/Bohrer/DataPrep_full.py')
# runcell('Choose Specific Features 1', 'D:/WZL_ags/12 Skit AE Pipe/Bohrer/DataPrep_full.py')

runcell('Include Wear rate', 'D:/WZL_ags/12 Skit AE Pipe/Bohrer/DataPrep_full.py')


#runcell('Correlation Matrix', 'D:/WZL_ags/12 Skit AE Pipe/Bohrer/DataPrep_full.py')
#runcell('PCA', 'D:/WZL_ags/12 Skit AE Pipe/Bohrer/DataPrep_full.py')

runcell('Prepare Data Set', 'D:/WZL_ags/12 Skit AE Pipe/Bohrer/DataPrep_full.py')
runcell('Transformation Pipline', 'D:/WZL_ags/12 Skit AE Pipe/Bohrer/DataPrep_full.py')


runcell('Linear Regression', 'D:/WZL_ags/12 Skit AE Pipe/Bohrer/DataPrep_full.py')
runcell('Decision Tree Regressor', 'D:/WZL_ags/12 Skit AE Pipe/Bohrer/DataPrep_full.py')
runcell('RandomForestRegressor', 'D:/WZL_ags/12 Skit AE Pipe/Bohrer/DataPrep_full.py')
runcell('Support Vector Maschine Regressor', 'D:/WZL_ags/12 Skit AE Pipe/Bohrer/DataPrep_full.py')
runcell('AdaBoost Regressor', 'D:/WZL_ags/12 Skit AE Pipe/Bohrer/DataPrep_full.py')
runcell('XGBoost Regressor', 'D:/WZL_ags/12 Skit AE Pipe/Bohrer/DataPrep_full.py')

runcell('GridSearch for Random Forest Regressor', 'D:/WZL_ags/12 Skit AE Pipe/Bohrer/DataPrep_full.py')
# runcell('GridSearch for SVR', 'D:/WZL_ags/12 Skit AE Pipe/Bohrer/DataPrep_full.py')


runcell('Cross Validation', 'D:/WZL_ags/12 Skit AE Pipe/Bohrer/DataPrep_full.py')

runcell('Evaluate Test DataSet', 'D:/WZL_ags/12 Skit AE Pipe/Bohrer/DataPrep_full.py')
...
data2 = data2[data2['Schnittgeschwindigkeit [m/min]'] == 80 ]

# data2 = data2[data2['Eingriffsbereich'] == "H"]

data2 = data2[data2['Versuch'] == "Vollbohrung"]

data2 = data2[data2['Werkzeug'] == 3]
...
data2 = data2[data2.columns.drop(list(data2.filter(regex='Mz')))]  ### 15.05.2020

data2 = data2[data2.columns.drop(list(data2.filter(regex='Fz')))]  ### 15.05.2020
...
feat =["Reihenfolge", "Werkzeug", "/'Untitled'/'AE_RAW_Futter'median"]
feat1 =["Reihenfolge","Werkzeug", "/'Untitled'/'AE_RAW_Futter'energy"]
feat2 =["Reihenfolge","Werkzeug", "/'Untitled'/'AE_RAW_Futter'mean"]
feat3 =["Reihenfolge","Werkzeug", "/'Untitled'/'AE_RAW_Futter'standarddeviation"]
feat4 =["Reihenfolge","Werkzeug", "/'Untitled'/'AE_RAW_Futter'variance"]
feat5 =["Reihenfolge","Werkzeug", "/'Untitled'/'AE_RAW_Futter'ecD1"]
...
feat =["Reihenfolge", "Werkzeug", "/'Untitled'/'AE_RAW_Aufnahme'median"]
feat1 =["Reihenfolge","Werkzeug", "/'Untitled'/'AE_RAW_Aufnahme'energy"]
feat2 =["Reihenfolge","Werkzeug", "/'Untitled'/'AE_RAW_Aufnahme'mean"]
feat3 =["Reihenfolge","Werkzeug", "/'Untitled'/'AE_RAW_Aufnahme'standarddeviation"]
feat4 =["Reihenfolge","Werkzeug", "/'Untitled'/'AE_RAW_Aufnahme'variance"]
feat5 =["Reihenfolge","Werkzeug", "/'Untitled'/'AE_RAW_Aufnahme'ecD1"]
...
data_train = train_set.drop(["vbarea","delta_vbarea", "Werkzeug","Schnittgeschwindigkeit [m/min]","Reihenfolge","Bohrtiefe", "Eingriffsbereich", "Versuch", "Filename"], axis=1)
data_train_labels =train_set["Reihenfolge"].copy()

data_test = test_set.drop(["vbarea","delta_vbarea", "Werkzeug","Schnittgeschwindigkeit [m/min]","Reihenfolge","Bohrtiefe", "Eingriffsbereich", "Versuch", "Filename"], axis=1)
data_test_labels = test_set["Reihenfolge"].copy()
